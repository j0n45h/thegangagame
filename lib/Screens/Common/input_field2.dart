                  ...
                  children: [
                    Container(
                      ...
                      child: RichText(text: TextSpan(
                        ...
                        style: TextStyle(color: Colors.white, fontSize: 35, fontFamily: 'NovaSquare'),
                      )
                      )
                    ...
                    SizedBox(
                      ...
                      child: (
                        PinCodeTextField(
                          ...
                          controller: _Value,
                          textStyle: TextStyle(color: Colors.white, fontSize: 40,fontFamily: 'NovaSquare'),
                          pinTheme: PinTheme(
                    ...
                    Container(
                        ...
                        child: Center(
                          child: Text(
                            feedback,
                            style: TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'NovaSquare'),
                            ),
                        ),
                    ),
                  ],
